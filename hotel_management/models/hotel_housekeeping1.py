...
class rr_housekeeping(models.Model):
    ...
    name = fields.Char(
        'Req No', size=30, readonly=True, states={'draft': [('readonly', False)]})
    ...
    shop_id = fields.Many2one('sale.shop', 'Shop', required=True, readonly=True, states={
                              'draft': [('readonly', False)]})
...
class issue_material_details(models.Model):
    ...
    complaint = fields.Char(
        'Complaint', size=250, readonly=True, states={'draft': [('readonly', False)]})
    shop_id = fields.Many2one('sale.shop', 'Shop', required=True, readonly=True, states={
                              'draft': [('readonly', False)]})
