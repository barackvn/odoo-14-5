...
class hotel_reservation(models.Model):
    ...
    def create(self, vals):
        print("fffffffffffffffffffffffffffffffffff111")
    ...
    adults = fields.Integer('Adults', readonly=True, states={'draft': [('readonly', False)]})
    childs = fields.Integer('Children',  readonly=True, states={'draft': [('readonly', False)]})
    ...
    number_of_rooms = fields.Integer(compute="_count_total_rooms", string="Number Of Rooms")
...
class hotel_reservation_line(models.Model):
    ...
    sub_total1 = fields.Float(string='Due Amount', store=True, readonly=False)
...
class hotel_folio_line(models.Model):
    ...
    def on_change_checkout(self):
        print("Checkoooooouutttt   000000000000000000000000000000");
        product_uom_id = ""
...
class product_template(models.Model):
    ...
    def create(self,vals_list):
        ...
        print(vals_list,'valssssssssssssssssssssssssssssss')
    ...
    def write(self, vals):
        ...
        print(self._context,'ressssssssssssssssssssssssssssssss',vals)
        return res
